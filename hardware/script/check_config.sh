...
# VDMA config.
vdma_config=("use_vdma" "vdma_dir" "vdma_w_fsync" "vdma_r_fsync" "vdma_aw" "vdma_mm_dw" "vdma_s_dw" "vdma_w_buffer_dep" "vdma_r_buffer_dep")
use_vdma_l=(0 1)
...
#----------------------------------------------------------------
# Basic check.
check_config_integrity "${vdma_config[@]}"
check_config_legal "${vdma_config[@]}"
