...
while [[ $i -ne 2 ]]; do
    ...
    if [[ ${!num} -ne 0 ]]; then 
        ...
        add_tcl "create_bd_cell -type ip -vlnv xilinx.com:ip:axi_interconnect:2.1 axi_interconnect_m_gp${i}"
        add_tcl "set_property -dict [list CONFIG.NUM_SI {1} CONFIG.NUM_MI {${!num}}] [get_bd_cells axi_interconnect_m_gp${i}]"
        # Assign AXI Interconnect slave port to zynq's M_AXI_GP.
        add_tcl "connect_bd_net [get_bd_pins clk_wiz_0/clk_out1] [get_bd_pins axi_interconnect_m_gp${i}/ACLK]"
        add_tcl "connect_bd_net [get_bd_pins proc_sys_reset_0/interconnect_aresetn] [get_bd_pins axi_interconnect_m_gp${i}/ARESETN]"
        add_tcl "connect_bd_intf_net [get_bd_intf_pins processing_system7_0/M_AXI_GP${i}] -boundary_type upper [get_bd_intf_pins axi_interconnect_m_gp${i}/S00_AXI]"
        add_tcl "connect_bd_net [get_bd_pins axi_interconnect_m_gp${i}/S00_ACLK] [get_bd_pins clk_wiz_0/clk_out1]"
        add_tcl "connect_bd_net [get_bd_pins axi_interconnect_m_gp${i}/S00_ARESETN] [get_bd_pins proc_sys_reset_0/interconnect_aresetn]"
    fi
    i=$((i+1))
done
i=0
while [[ $i -ne 2 ]]; do
    ...
    if [[ ${!num} -ne 0 ]]; then
        ...
        add_tcl "create_bd_cell -type ip -vlnv xilinx.com:ip:axi_interconnect:2.1 axi_interconnect_s_gp${i}"
        add_tcl "set_property -dict [list CONFIG.NUM_SI {${!num}} CONFIG.NUM_MI {1}] [get_bd_cells axi_interconnect_s_gp${i}]"
        # Assign AXI Interconnect master port to zynq's S_AXI_GP.
        add_tcl "connect_bd_net [get_bd_pins clk_wiz_0/clk_out1] [get_bd_pins axi_interconnect_s_gp${i}/ACLK]"
        add_tcl "connect_bd_net [get_bd_pins proc_sys_reset_0/interconnect_aresetn] [get_bd_pins axi_interconnect_s_gp${i}/ARESETN]"
        add_tcl "connect_bd_intf_net [get_bd_intf_pins processing_system7_0/S_AXI_GP${i}] -boundary_type upper [get_bd_intf_pins axi_interconnect_s_gp${i}/M00_AXI]"
        add_tcl "connect_bd_net [get_bd_pins axi_interconnect_s_gp${i}/M00_ACLK] [get_bd_pins clk_wiz_0/clk_out1]"
        add_tcl "connect_bd_net [get_bd_pins axi_interconnect_s_gp${i}/M00_ARESETN] [get_bd_pins proc_sys_reset_0/interconnect_aresetn]"
    fi
    i=$((i+1))
done
i=0
while [[ $i -ne 4 ]]; do
    ...
    if [[ ${!num} -ne 0 ]]; then
        ...
        # Add AXI Interconnect and config slave port number.
        add_tcl "create_bd_cell -type ip -vlnv xilinx.com:ip:axi_interconnect:2.1 axi_interconnect_s_hp${i}"
        add_tcl "set_property -dict [list CONFIG.NUM_SI {${!num}} CONFIG.NUM_MI {1}] [get_bd_cells axi_interconnect_s_hp${i}]"        
        # Assign AXI Interconnect master port to zynq's S_AXI_HP.
        add_tcl "connect_bd_net [get_bd_pins clk_wiz_0/clk_out1] [get_bd_pins axi_interconnect_s_hp${i}/ACLK]"
        add_tcl "connect_bd_net [get_bd_pins proc_sys_reset_0/interconnect_aresetn] [get_bd_pins axi_interconnect_s_hp${i}/ARESETN]"
        add_tcl "connect_bd_intf_net [get_bd_intf_pins processing_system7_0/S_AXI_HP${i}] -boundary_type upper [get_bd_intf_pins axi_interconnect_s_hp${i}/M00_AXI]"
        add_tcl "connect_bd_net [get_bd_pins axi_interconnect_s_hp${i}/M00_ACLK] [get_bd_pins clk_wiz_0/clk_out2]"
        add_tcl "connect_bd_net [get_bd_pins axi_interconnect_s_hp${i}/M00_ARESETN] [get_bd_pins proc_sys_reset_1/interconnect_aresetn]"
    fi
    i=$((i+1))
done
...
add_tcl "make_bd_intf_pins_external  [get_bd_intf_pins axi_interconnect_m_gp0/M00_AXI]"
add_tcl "connect_bd_net [get_bd_pins axi_interconnect_m_gp0/M00_ACLK] [get_bd_pins clk_wiz_0/clk_out3]"
add_tcl "connect_bd_net [get_bd_pins axi_interconnect_m_gp0/M00_ARESETN] [get_bd_pins proc_sys_reset_2/peripheral_aresetn]"
...
while [[ $i -ne $m_axil_user_num ]]; do
    add_tcl "make_bd_intf_pins_external  [get_bd_intf_pins axi_interconnect_m_gp0/M${s_axi_gp0_assign}_AXI]"
    ...
    add_tcl "set_property name M_AXIL_USER${i} [get_bd_intf_ports M${s_axi_gp0_assign}_AXI_0]"
